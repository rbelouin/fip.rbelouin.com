...
test("SongList should display one row per song", function(t) {
  ...
  t.equal(document.querySelectorAll("main .song-list tbody tr").length, songs.length);
...
test("SongList should display the information of every song", function(t) {
  ...
  _.each(songs, function(song, index) {
    ...
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(2)").textContent, song.title);
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(3)").textContent, song.artist);
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(4)").textContent, song.album);
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(5)").textContent, song.year);
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(6)").textContent, song.label);
  });
