...
test("SongList should display the information of every song", function(t) {
  ...
  _.each(songs, function(song, index) {
    ...
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(3)").textContent, song.title);
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(4)").textContent, song.artist);
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(5)").textContent, song.album);
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(6)").textContent, song.year);
    t.equal(document.querySelector("main .song-list tbody tr:nth-child(" + (index + 1) + ") td:nth-child(7)").textContent, song.label);
  });
